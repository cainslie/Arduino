...
def flash_size (size_bytes, display, optname, ld, desc, max_upload_size, spiffs_start = 0, spiffs_size = 0, spiffs_blocksize = 0):
    ...
    d = collections.OrderedDict([
        ...
        ( menub + 'flash_size_bytes', "%X" % size_bytes ),
        ( menub + 'flash_ld', ld ),
...
def all_flash_size ():
    f512 =      flash_size(0x80000,  '512K', '512K0',   'eagle.flash.512k0.ld',     'no SPIFFS', 499696)
    ...
    f1m =       flash_size(0x100000,   '1M', '1M0',     'eagle.flash.1m0.ld',       'no SPIFFS', 1023984)
